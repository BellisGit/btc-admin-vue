        ...
        <div v-if="currentStep === 0">
          ...
          >
            <btc-form-item
              ...
              label-mode="auto"
            >
              <btc-form-item label="企业邮箱" prop="empId">
                <el-input
                  v-model="viewModel.identityForm.empId"
                  placeholder="请输入企业邮箱"
                  clearable
                >
                  <template #append>@bellis-technology.cn</template>
                </el-input>
              </el-form-item>

              <btc-form-item label="验证码" prop="smsCode">
                <el-input
                  v-model="viewModel.identityForm.smsCode"
                  placeholder="请输入验证码"
                  maxlength="6"
                  clearable
                >
                  <template #suffix>
                    ...
                    >
                      {{ viewModel.smsCountdown.value > 0 ? `${viewModel.smsCountdown.value}s` : '发送验证码' }}
                    </el-button>
                  </template>
                </el-input>
              </el-form-item>
